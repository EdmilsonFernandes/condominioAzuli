...
window.webcam = {
	...
	swf_url: 'camutils/webcam.swf', // URI to webcam.swf movie (defaults to cwd) - Leonel F: camutils/ é o diretório onde se encontra o arquivo Flash, em relação à raíz do site
	shutter_url: 'shutter.mp3', // URI to shutter.mp3 sound //Leonel F.: Este arquivo deve estar no diretório raíz do site. Ao movê-lo, a API não funcionou.
	...
	get_movie: function() {
		...
		if (!this.loaded) return alert("ERROR: A Camera não foi iniciada");
