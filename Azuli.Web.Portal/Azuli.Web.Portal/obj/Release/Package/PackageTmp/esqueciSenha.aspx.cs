        ...
        protected void btnEsqueci_Click(object sender, EventArgs e)
        {
            ...
            if (rg.IsMatch(txtEm.Text))
            {
                ...
                try
                {
                    ...
                    {
                        oEnviaEmail.enviaSenha("A senha para o apartamento" + oProprietarioModel.ap.apartamento + " do bloco " + oProprietarioModel.ap.bloco + " é " + vMail + Environment.NewLine + " http://condominiospazioazuli.somee.com/LoginAzulli.aspx ", oProprietarioModel.ap.apartamento.ToString(), oProprietarioModel.email, 1);
