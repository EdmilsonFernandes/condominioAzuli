...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:SqlDataSource ID="SqlDataSourceGerenciamentoUser" runat="server" ConnectionString="<%$ ConnectionStrings:azulli %>"
        ...
        InsertCommand="INSERT INTO [PROPRIETARIO] ([NOME_PROPRIETARIO1], [PROPRIETARIO_BLOCO], [PROPRIETARIO_AP], [email],[STATUS],[TELEFONE],[PROPRIETARIO_IMOVEL]) VALUES (@NOME_PROPRIETARIO1, @NOME_PROPRIETARIO2, @PROPRIETARIO_BLOCO, @PROPRIETARIO_AP, @email, @STATUS,[TELEFONE],[PROPRIETARIO_IMOVEL])"
