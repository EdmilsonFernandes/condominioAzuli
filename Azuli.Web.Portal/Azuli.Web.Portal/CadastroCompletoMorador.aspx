            ...
            <center>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:DropDownList ID="drpBloco" runat="server" Height="25px" Width="154px" Style="font-size: medium; font-weight: 700;"
                                CssClass="AlternatingRowStyle" AutoPostBack="True" 
                                onselectedindexchanged="drpBloco_SelectedIndexChanged">
                        ...
                        <td style="text-align: left">
                            ...
                            <asp:DropDownList ID="ddLApartamentos" runat="server" 
                                ...
                                AutoPostBack="True" 
                                onselectedindexchanged="ddLApartamentos_SelectedIndexChanged">
                                <asp:ListItem Selected="True" Value="-1">Escolha o AP ..</asp:ListItem>
                            </asp:DropDownList>
                        </td>
                        <td style="text-align: left">
                        ...
                        <td style="text-align: left">
                            <asp:DropDownList ID="ddlQuantidadeGarage" runat="server" 
                                ...
                                CssClass="AlternatingRowStyle" Height="38px" Width="174px">
                                <asp:ListItem Value="-1">Quantas garagem?</asp:ListItem>
                                <asp:ListItem>1</asp:ListItem>
                                <asp:ListItem>2</asp:ListItem>
                            </asp:DropDownList>
                        </td>
                ...
                <table class="GridView" dir="ltr">
                    <tr class="form">
                        ...
                        <td class="style24" align="left">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtCond01"
                                ...
                                Style="color: #FF3300; font-weight: 700" ErrorMessage="Campo obrigatório">*</asp:RequiredFieldValidator>
                        </td>
                        <td class="style15">
                    ...
                    <tr>
                        ...
                        <td class="style24" align="left">
                            &nbsp;
                            <asp:TextBox ID="txtCPF" runat="server" ClientIDMode="Static" MaxLength="200" 
                                AutoPostBack="True" Width="129px"
                                OnTextChanged="txtCPF_TextChanged" CssClass="style23"></asp:TextBox>
                            &nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtCPF"
                                ValidationGroup="InputValidationGroup" 
                                Style="color: #FF3300; font-weight: 700" ErrorMessage="Campo obrigatório">*</asp:RequiredFieldValidator>
                            ...
                            &nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;<asp:TextBox ID="txtRg" runat="server" 
                                MaxLength="200" AutoPostBack="True"
                                Width="136px" CssClass="style23"></asp:TextBox>
                        </td>
                        <td align="left" class="form" colspan="2">
                            ...
                            <asp:TextBox ID="txtEmail" runat="server" MaxLength="200" AutoPostBack="True" 
                                Width="278px" CssClass="style23" ontextchanged="txtEmail_TextChanged"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtEmail"
                                ValidationGroup="InputValidationGroup" 
                                Style="font-weight: 700; color: #FF3300" ErrorMessage="Campo obrigatório">*</asp:RequiredFieldValidator>
                    ...
                    <tr>
                        ...
                        <td class="style24" align="left">
                            ...
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="lblCepNaoEcontrado" runat="server" 
                            ...
                            &nbsp;&nbsp;
                            <asp:TextBox ID="txtBairro" runat="server" MaxLength="200" AutoPostBack="True" 
                                Width="168px" Style="margin-top: 0px"
                        ...
                        <td class="form">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtTelefone"
                                ValidationGroup="InputValidationGroup" 
                                Style="color: #FF3300; font-weight: 700" ErrorMessage="Campo obrigatório">*</asp:RequiredFieldValidator>
                        </td>
                    </tr>
                ...
                <asp:Button ID="btnFinalizaCadastro" runat="server" CssClass="modalHeader" 
                    ...
                    Width="158px" ValidationGroup="InputValidationGroup" />
                &nbsp;&nbsp;&nbsp;
